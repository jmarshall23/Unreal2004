...
Preferences=(Caption="Alias touches",Parent="Avancé",Class=Engine.Input,Immediate=True,Category=Aliases)
Preferences=(Caption="Liens touches",Parent="Avancé",Class=Engine.Input,Immediate=True,Category=RawKeys)
...
FemaleSuicide="%o téléfraggé(e) par %k"
MaleSuicide="%o téléfraggé(e) par %k"
