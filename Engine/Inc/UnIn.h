...
struct FAlias
{
	FName Alias GCC_PACK(1);
	FString Command GCC_PACK(1);
	FAlias()
	: Alias()
	, Command( E_NoInit )
	{}
...
class ENGINE_API UInput : public USubsystem
{
	...
	virtual UBOOL IsBoundTo( const TCHAR* Command, const BYTE& iKey ) const;
	virtual const TCHAR* TranslateAlias( const TCHAR* Alias ) const;
