...
{
    BYTE MeshSectionMethod GCC_PACK(4);
...
{
    FLOAT DistanceFactor GCC_PACK(4);
...
{
    FVector A_Translation GCC_PACK(4);
    FRotator A_Rotation;
    FName AttachAlias;
    FName BoneName;
    FLOAT Test_Scale;
...
{
public:
    PTRINT WBrowserAnimationPtr GCC_PACK(4);
    FVector Scale;
    FVector Translation;
    FRotator Rotation;
    FVector MinVisBound;
    ...
    class UStaticMesh* CollisionStaticMesh;
...
{
public:
    INT OldArrayCount GCC_PACK(4);
    PTRINT WBrowserAnimationPtr;
...
public:
    PTRINT WBrowserAnimationPtr GCC_PACK(4);
    BITFIELD WeldDuplicateVertices:1 GCC_PACK(4);
