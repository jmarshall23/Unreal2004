...
REGISTER_NAME(  16, PointerProperty)//!!
...
REGISTER_NAME(  24, Fire             )
REGISTER_NAME(  26, IpDrv            )
REGISTER_NAME(  27, UWeb             )
REGISTER_NAME(  28, UnrealGame       )
REGISTER_NAME(  29, XEffects         )
REGISTER_NAME(  30, XPickups         )
REGISTER_NAME(  31, XGame            )
REGISTER_NAME(  32, XWeapons         )
REGISTER_NAME(  33, XInterface       )
REGISTER_NAME(  34, Vehicles         )
REGISTER_NAME(  35, UT2k4Assault     )
REGISTER_NAME(  36, Onslaught        )
REGISTER_NAME(  37, GUI2K4           )
...
REG_NAME_HIGH(  94, Pointer          )
REG_NAME_HIGH(  95, Quat             )
...
REG_NAME_HIGH( 698, ExportStructs) //amb
REG_NAME_HIGH( 699, DependsOn) //amb
REG_NAME_HIGH( 693, HideDropDown)
REG_NAME_HIGH( 694, CacheExempt)	// rjp - cache manager ignore this class
REG_NAME_HIGH( 849, ParseConfig)    // rjp - parse config filename from commandline
...
REGISTER_NAME( 927, RecordCache)
REGISTER_NAME( 843, Debug )
REGISTER_NAME( 844, DebugRon )
REGISTER_NAME( 845, MenuText )
REGISTER_NAME( 846, MusicPlayer )
REGISTER_NAME( 847, VoiceChat )
REGISTER_NAME( 848, ModAuthor )
REGISTER_NAME( 863, DevKarma )
...
// gam ---
REGISTER_NAME( 841, ProceduralSound)
REGISTER_NAME( 842, SoundGroup)
// --- gam

// gam --- XInterface structure names for fast lookup
...
REGISTER_NAME( 910, Long )
REGISTER_NAME( 911, ShitBag )
// --- gam
...
REGISTER_NAME( 304, Created 		 ) // amb: notification for objects after creation
