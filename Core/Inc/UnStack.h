...
// Sizes.
enum {MAX_STRING_CONST_SIZE		= 1024              }; // gam
...
enum EExprToken
{
	...
	EX_DebugInfo			= 0x42,	//DEBUGGER Debug information
	...
	EX_PointerConst 		= 0x46,	// Int constant.
	EX_EndOfScript			= 0x47, // Last byte in script code
