...
BoxCar is a very simple vehicle simulation with steering and 
suspension using the MdtCarWheel joint. The vehicle is controlled 
by dragging the mouse in the display window.
