...
coordT *qh_copypoints (coordT *points, int numpoints, int dimension) {
  ...
  if (!(newpoints=(coordT*)MeMemoryAPI.create(size))) {
...
void qh_joggleinput (void) {
  ...
  if (!qh input_points) { /* first call */
    ...
    if (!(qh first_point=(coordT*)MeMemoryAPI.create(size))) {
...
void qh_projectinput (void) {
  ...
  if (!(newpoints=(coordT*)MeMemoryAPI.create(newnum*newdim*sizeof(coordT)))){
...
coordT *qh_sethalfspace_all (int dim, int count, coordT *halfspaces, pointT *feasible) {
  ...
  newdim= dim - 1;
  if (!(newpoints=(coordT*)MeMemoryAPI.create(count*newdim*sizeof(coordT)))){
