...
static int MEAPI_CDECL qh_compareangle(const void *p1, const void *p2);
static int MEAPI_CDECL qh_comparemerge(const void *p1, const void *p2);
static int MEAPI_CDECL qh_comparevisit (const void *p1, const void *p2);
...
void qh_tracemerging (void) {
  ...
  time (&timedata);
#else
  /* As usual, leave it full of junk... */
#endif
