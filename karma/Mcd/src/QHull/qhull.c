...
void qh_buildtracing (pointT *furthest, facetT *facet) {
  ...
  if (!furthest) {
      ...
      time (&timedata);
#else
      /* I really don't think we need this on PS2 at the moment! If we ever
       do, I'll have to try to work out how to do it, I suppose. For the
       time being, then, this timedata will just contain junk. */
#endif
