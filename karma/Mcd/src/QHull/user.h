...
*/
#include "meqhull.h" /* set precision */
#ifndef REALfloat
#define REALfloat 1
#endif
...
/*-<a                             href="qh-c.htm#user"
  ...
  notes:
   ...
   Set qh_CLOCKtype to
     ...
     3      for Nintendo Dolphin
*/
#define qh_CLOCKtype 3  /* change to the desired number */
