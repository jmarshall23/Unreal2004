...
/*
   ...
   Date: $Date: 2002/04/04 15:28:53 $ - Revision: $Revision: 1.21.2.3 $
...
*/
McdConvexMeshID MEAPI McduConvexMeshCreateHullFromObj(const char *filename,
                                                      McdFramework *frame,
                                                      MeReal scale, int center);
