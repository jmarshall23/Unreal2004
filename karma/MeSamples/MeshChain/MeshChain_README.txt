README - MeshChain
~ example program
Toolkits demonstrated: Collision and Dynamics using TriangleMesh geometry
last updated: June 22, 2000


Overview:
This example shows collision detection using the 
McdTriangleMesh geometry, which can be used to represent
any shape, convex or non-convex.
