...
/*
   ...
   Date: $Date: 2002/04/04 15:29:14 $ - Revision: $Revision: 1.9.6.1 $
...
void MEAPI UpdateConstraintGraphics(void)
{
    ...
    for (i = 0; i < nBSJoints; i++) {
        MeMatrix4MultiplyMatrix(BSJointTM[i],(void *)bsjointID[i]->head.ref1,(void *)MdtBodyGetCenterOfMassTransformPtr(MdtConstraintGetBody(bsjointID[i],0)));
    }
    for (i = 0; i < nHinges; i++) {
        MeMatrix4MultiplyMatrix(HingeTM[i],(void *)hingeID[i]->head.ref1,(void *)MdtBodyGetCenterOfMassTransformPtr(MdtConstraintGetBody(hingeID[i],0)));
    }
    for (i = 0; i < nCarwheels; i++) {
        MeMatrix4MultiplyMatrix(CarwheelTM[i],(void *)carwheelID[i]->head.ref2,(void *)MdtBodyGetCenterOfMassTransformPtr(MdtConstraintGetBody(carwheelID[i],1)));
    }
    for (i = 0; i < nPrismatics; i++) {
        MeMatrix4MultiplyMatrix(PrismaticTM[i],(void *)prismaticID[i]->head.ref1,(void *)MdtBodyGetCenterOfMassTransformPtr(MdtConstraintGetBody(prismaticID[i],0)));
    }
    ...
    if (b) {
        ...
        while (c) {
            if (MdtConstraintDCastBSJoint(c)) {
                ...
                MeMatrix4MultiplyMatrix(BSJointTM[nBSJoints],(void *)c->head.ref1,(void *)MdtBodyGetCenterOfMassTransformPtr(MdtConstraintGetBody(c,0)));
    ...
    if (b) {
        ...
        while (c) {
            if (MdtConstraintDCastHinge(c)) {
                ...
                hingeID[nHinges] = c;
                MeMatrix4MultiplyMatrix(HingeTM[nHinges],(void *)c->head.ref1,(void *)MdtBodyGetCenterOfMassTransformPtr(MdtConstraintGetBody(c,0)));
    ...
    if (b) {
        ...
        while (c) {
            if (MdtConstraintDCastPrismatic(c)) {
                ...
                MeMatrix4MultiplyMatrix(PrismaticTM[nPrismatics],(void *)c->head.ref1,(void *)MdtBodyGetCenterOfMassTransformPtr(MdtConstraintGetBody(c,0)));
    ...
    if (b) {
        ...
        while (c) {
            if (MdtConstraintDCastCarWheel(c)) {
                ...
                MeMatrix4MultiplyMatrix(CarwheelTM[nCarwheels],(void *)c->head.ref2,(void *)MdtBodyGetCenterOfMassTransformPtr(MdtConstraintGetBody(c,1)));
