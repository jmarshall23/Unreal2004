...
This program demonstrates using the Dynamics Toolkit to simulate very
large numbers of rigid bodies. Collision detection and response is
hand-coded for this application. Each box hits the floor and splits
into 8 smaller boxes. Each smaller box then splits into 8 further boxes.
A maximum of about 2000 bouncing bodies is reached.
