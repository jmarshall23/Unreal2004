...
typedef int (*AVCommandParseFunc)(char* cmd, unsigned int cmdLength, char** retString, unsigned int *retLength);
int     CommandParse(char* cmd, unsigned int cmdLength, char** retString, unsigned int *retLength);


typedef int  (MEAPI *AVNetInitFunc)(void);
typedef void (MEAPI *AVNetCleanupFunc)(void);
typedef void (MEAPI *AVNetPollFunc)(AVCommandParseFunc);

extern AVNetInitFunc    PlatformNetworkInit;
extern AVNetCleanupFunc PlatformNetworkCleanup;
extern AVNetPollFunc    PlatformNetworkPoll;
