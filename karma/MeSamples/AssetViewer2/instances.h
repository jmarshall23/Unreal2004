...
#ifndef AV_INSTANCES_H
#define AV_INSTANCES_H

#include "AssetViewer2.h"

typedef struct _assetinstance *AssetInstancePtr;

typedef struct _assetinstance
{
    char*       m_instancename;
    int         m_assetID;
    MeMatrix4   m_initTM;
    
    AssetInstancePtr m_next;
} AssetInstance;

AssetInstancePtr        instances; /* linked list of instances */
