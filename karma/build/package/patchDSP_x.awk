...
#   optimizing compiler).
#
#   Last modified by: $Author: richardm $
#   Last modified on: $Date: 2002/02/25 10:11:04 $
#
#=================================================================
...
#    gsub("/xbox", "/"FORCED_LIB_CONFIG, FORCED_LIB_DIRECTIVE)
#  }
...
stripConfigs && /CFG=/ { 
  sub("- Xbox Release " stripSuffixes, "- Xbox Release")
  sub("- Xbox Debug "   stripSuffixes, "- Xbox Debug")
}
...
isLINK {
  ...
  # should search for ..\..\lib.*\xbox => ..\..\lib.*\FORCED_LIB_CONFIG
  if (FORCED_LIB_CONFIG != "")
  {
    gsub("/xbox", "/"FORCED_LIB_CONFIG)
