...
When building the SNSys compiler will probably output a number of warnings.
...
Also see the "3rdParty/README_SNSys.txt" file.
...
Also see the "3rdParty/README_CWPS2.txt" file.
