...
can be built in any UNIX-like environment by executing the makefile using make.
...
The resulting example and tutorial executables are put in examples/bin.[config]/[platform]
and tutorials/bin.[config]/[platform] respectively.
The component libraries are created in the components/lib.[config]/[platform] directory.
