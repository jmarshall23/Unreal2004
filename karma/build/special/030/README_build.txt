...
NOTE: To create a new project for a Windows application, you may need to add
some libraries that may also be required. In MSVC, go to Project -> Setting,
select the Link tab, then select Input in the Category list. You can now add the
following libraries to the Object/libraries modules text box:
