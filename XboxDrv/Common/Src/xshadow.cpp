...
void CXShadowVolume::Render()
{
    ...
    g_pd3dDevice->SetRenderState(D3DRS_SHADEMODE, D3DSHADE_FLAT);    // don't interpolate colors
    g_pd3dDevice->SetRenderState(D3DRS_STENCILFUNC, D3DCMP_ALWAYS);    // stencil test always passes
                                                                    // don't need fail setup since always passes
    ...
    g_pd3dDevice->SetRenderState(D3DRS_ALPHABLENDENABLE, TRUE);        // don't draw any pixels
