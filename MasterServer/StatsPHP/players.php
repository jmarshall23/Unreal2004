...
if( $included_get_nickname == 0 )
	include "func/get_nickname.inc";
...
<a name=pDM></a>
<?php
	$mode_playersRanked=0;					//DM
	include "stats/table_playersRanked.inc";
?>
<p>
...
<?php
	$info_text   = $info_text_l3[$global_page];
	include "inc/table_info.inc";			//generate info box
?>
<p>
...
<?php
	$info_text   = $info_text_l4[$global_page];
	include "inc/table_info.inc";			//generate info box
?>
<p>
