...
class Pro_PlayerSettings extends GUITabPanel
	config(ProUI);
...
var config int FOVMin;
var config int FOVMax;

function InitComponent(GUIController MyController, GUIComponent MyOwner)
{
	local int i;
    local moNumericEdit n;
	...
	n = moNumericEdit(Controls[12]);

	n.MyNumericEdit.Step = 1;
    n.MyNumericEdit.MinValue = FOVMin;
    n.MyNumericEdit.MaxValue = FOVMax;

	GUIEditBox(n.MyNumericEdit.Controls[0]).bReadOnly = true;
}
...
defaultproperties
{
	Begin Object class=GUIImage Name=ProPlayerBK1
		WinWidth=0.434062
		WinHeight=0.307382
		WinLeft=0.506016
		WinTop=0.008854
	...
	End Object
	Controls(0)=GUIImage'ProPlayerBK1'

	Begin Object class=moEditBox Name=ProPlayerName
		WinWidth=0.375000
		WinHeight=0.060000
		WinLeft=0.527343
		WinTop=0.047397
		...
		CaptionWidth=0.25
	End Object
	Controls(1)=moEditBox'ProPlayerName'

	Begin Object class=moComboBox Name=ProPlayerTeam
		WinWidth=0.393750
		WinHeight=0.060000
		WinLeft=0.524766
		WinTop=0.036979
        ...
        bVisible=false
	End Object
	Controls(2)=GUIMenuOption'ProPlayerTeam'


	Begin Object class=moComboBox Name=ProPlayerHand
		WinWidth=0.393750
		WinHeight=0.060000
		WinLeft=0.524766
		WinTop=0.130729
        ...
        bVisible=false
	End Object
	Controls(3)=GUIMenuOption'ProPlayerHand'

	Begin Object class=GUICharacterListTeam Name=ProPlayerCharList
		WinWidth=0.453729
		WinHeight=0.189297
		WinLeft=0.036465
		WinTop=0.813543
	...
	End Object
	Controls(4)=GUICharacterListTeam'ProPlayerCharList'

	Begin Object Class=GUIScrollTextBox Name=ProPlayerScroll
		WinWidth=0.472071
		WinHeight=0.445508
		WinLeft=0.506132
		WinTop=0.343500
	...
	End Object
	Controls(5)=GUIScrollTextBox'ProPlayerScroll'

	Begin Object class=GUIButton Name=ProPlayerLeft
		WinWidth=0.043555
		WinHeight=0.084414
		WinLeft=0.000781
		WinTop=0.886460
		...
		StyleName="ArrowLeft"
	End Object
	Controls(6)=GUIButton'ProPlayerLeft'

	Begin Object class=GUIButton Name=ProPlayerRight
		WinWidth=0.043555
		WinHeight=0.084414
		WinLeft=0.479688
		WinTop=0.886460
		...
		OnClickSound=CS_Up
	End Object
	Controls(7)=GUIButton'ProPlayerRight'

	Begin Object class=GUIImage Name=ProPlayerPortrait
		WinWidth=0.183000
		WinHeight=0.637000
		WinLeft=0.172250
		WinTop=0.024583
	...
	End Object
	Controls(8)=GUIImage'ProPlayerPortrait'

	Begin Object class=GUIButton Name=ProPlayer3DView
		WinWidth=0.250000
		WinHeight=0.050000
		WinLeft=0.620000
		WinTop=0.927086
	...
	End Object
	Controls(9)=GUIButton'ProPlayer3DView'

	Begin Object class=GUIImage Name=ProPlayerPortraitBorder
		WinWidth=0.188563
		WinHeight=0.647875
		WinLeft=0.168687
		WinTop=0.018500
		...
		ImageStyle=ISTY_Stretched
	End Object
	Controls(10)=GUIImage'ProPlayerPortraitBorder'

	Begin Object class=GUIImage Name=ProPlayer3DBack
		WinWidth=0.472071
		WinHeight=0.742383
		WinLeft=0.506132
		WinTop=0.156000
	...
	End Object
	Controls(11)=GUIImage'ProPlayer3DBack'

	Begin Object class=moNumericEdit Name=ProPlayerFOV
		WinWidth=0.393750
		WinHeight=0.060000
		WinLeft=0.524766
		WinTop=0.186456
	...
	End Object
	Controls(12)=moNumericEdit'ProPlayerFOV'
