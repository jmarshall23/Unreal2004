...
defaultproperties
{
    ...
    BorderOffsets(2)=5
    BorderOffsets(3)=10
    Images(0)=Material'2K4Menus.Controls.editbox_d'
    Images(1)=Material'2K4Menus.Controls.editbox_w'
    Images(2)=Material'2K4Menus.Controls.editbox_f'
    Images(3)=Material'2K4Menus.Controls.editbox_p'
    Images(4)=Material'2K4Menus.Controls.editbox_d'
