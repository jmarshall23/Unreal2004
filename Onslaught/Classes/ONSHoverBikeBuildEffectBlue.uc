...
//
//-----------------------------------------------------------
class ONSHoverBikeBuildEffectBlue extends ONSVehicleBuildEffect;
...
DefaultProperties
{
    Begin Object Class=SpriteEmitter Name=SpriteEmitter3
        ...
        ColorScale(1)=(RelativeTime=1.0,Color=(B=255))
    ...
    Begin Object Class=SpriteEmitter Name=SpriteEmitter4
        ...
        StartLocationRange=(X=(Min=35.000000,Max=35.000000),Z=(Min=-50.000000,Max=-50.000000))
        UseRotationFrom=PTRS_Actor
        SizeScale(0)=(RelativeTime=1.000000,RelativeSize=0.750000)
        StartSizeRange=(X=(Min=250.000000,Max=250.000000),Y=(Min=250.000000,Max=250.000000))
