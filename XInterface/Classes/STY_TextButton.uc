...
defaultproperties
{
	KeyName="TextButton"
	Images(0)=None
	Images(1)=Material'InterfaceContent.menus.ButtonBobFinal'
	Images(2)=Material'InterfaceContent.menus.ButtonBobFinal'
	Images(3)=Material'InterfaceContent.menus.ButtonBobFinal'
