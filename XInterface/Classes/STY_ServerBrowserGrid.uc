...
defaultproperties
{
	...
	Images(0)=Material'InterfaceContent.Menu.BorderBoxF'
	Images(1)=Material'InterfaceContent.Menu.BorderBoxF'
	Images(2)=Material'InterfaceContent.Menu.BorderBoxF'
	Images(3)=Material'InterfaceContent.Menu.BorderBoxF'
	Images(4)=Material'InterfaceContent.Menu.BorderBoxF'
